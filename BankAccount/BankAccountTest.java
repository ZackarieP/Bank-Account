		...
		while (nMenuOption != 10) { // start while statement for menu option
			...
			switch (nMenuOption) { // switch statement to use flow control
				...
				case 2: // second case
					...
					myBankAccount = new BankAccount(dBalance, dIntRate); // create new object with overloaded
																			// constructor
					System.out.println("Account #" + myBankAccount.getAccountNumber() + // print account number
							" successfully created."); // print account number
					break; // case break
				...
				case 4: // fourth case
					...
					if (dWithdrawal > myBankAccount.getBalance()) {
				...
				case 5: // fifth case
					System.out.println("Monthly interest earned: $" + myBankAccount.getMonthlyInterestRate());
					break; // case break
				...
				case 7: // seventh case
					System.out.println("Next available account number is: " + myBankAccount.getNextAccountNumber());
					break; // case break
